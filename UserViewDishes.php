...
<section class="resume-section" id="awards">
    ...
    <div class="resume-section-content" style="" id="signup">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
 <select id="categoryoption" onchange="getDishByCategory(this.value)" style="width: 50%; margin-left: 30%;margin-bottom:5%;"></select>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">Details of Dish</h4>
